...
public class HospitalAdminSignUpDTO {

    @Email(message = "Email should be valid")
    @NotBlank(message = "The Email is mandatory")
    private String email;

//    @Email(message = "address should be valid")
...
//    public @NotBlank(message = "Address should be valid") @NotBlank(message = "Address is mandatory") String getAddress() {
//        return address;
//    }
